...
<button
  ...
  class="flex flex-col content-center items-center w-full p-4 bg-base-200 border border-success border-error border-warning rounded-md"
  onclick={() => show = !show}>
